...
const DrivingLicenseCard = ({ onUploadComplete }: DrivingLicenseCardProps) => {
      ...
      if (!permissionsRequested) {
        ...
        if (!cameraPermission.granted || !mediaLibraryPermission.granted) {
          Alert.alert(
            ...
            "Please grant camera and photo library permissions to upload your driving license photos.",
            [{ text: "OK" }]
          )
        }
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Upload Driving License Photos</Text>
      <Text style={styles.subtitle}>We need photos of both sides of your driving license</Text>
      ...
      <View style={styles.tipsContainer}>
        ...
        <Text style={styles.tipItem}>• Place license on a dark background</Text>
      </View>
    </View>
  )
}
