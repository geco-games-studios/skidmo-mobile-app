...
const PropertyFormScreen = () => {
  ...
  const navigation = useNavigation(); // Use the useNavigate hook for navigation
      const router = useRouter()
         ...
         useEffect(() => {
            navigation.setOptions({ title: "Long-Term Property" }) // Set custom title
          }, [navigation])
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.formScrollView}>
        ...
        {/* More form fields would go here - abbreviated for clarity */}
        ...
        {/* More amenities would go here - abbreviated for clarity */}
